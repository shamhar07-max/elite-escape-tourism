...
(function(){
  ...
  if(fab&&panel){
    ...
    const reply=q=>{
      ...
      if(/safari|desert|dhow|burj|attraction|museum|ferrari|miracle/.test(s))return `Desert safari runs <b>daily with hotel pickup</b> — dune bashing, camel, BBQ &amp; Tanoura. See <a href="/elite-escape-tourism/attractions.html"><b>all 14 UAE icons →</b></a> or <a href="${waLink("I want to book a desert safari")}" target="_blank" rel="noopener"><b>book on WhatsApp →</b></a>`;
      const hit=COUNTRIES.find(c=>s.includes(c));
      if(/visa/.test(s)||hit){const where=hit?` for <b>${hit.charAt(0).toUpperCase()+hit.slice(1)}</b>`:"";
        return `For visas${where}: message us your <b>passport nationality + travel dates</b> and a specialist replies with a dated checklist. <a href="/elite-escape-tourism/visa.html"><b>Browse 49 visa desks →</b></a> or <a href="${waLink("Visa help"+(hit?" to "+hit:""))}" target="_blank" rel="noopener"><b>start on WhatsApp →</b></a>`}
      if(/honeymoon|family|holiday|package|tour|japan|bali|georgia|paris|travel|trip|book/.test(s))return `Lovely choice. Our signatures: <a href="/elite-escape-tourism/tours/japan-7-day-essential.html"><b>Japan 7-day</b></a> · <a href="/elite-escape-tourism/tours/georgia-armenia-7-day.html"><b>Georgia–Armenia</b></a> · <a href="/elite-escape-tourism/tours/bali-5-day.html"><b>Bali 5-day</b></a>. Or see <a href="/elite-escape-tourism/holidays.html"><b>all 24 tours →</b></a>. For dates &amp; availability: <a href="${waLink("Holiday enquiry: "+q.slice(0,80))}" target="_blank" rel="noopener"><b>ask on WhatsApp →</b></a>`;
